"""
02v2_run_baselineB_VAE.py — Baseline B (VAE 版)
方法：DF_maj → VAE + OneClassSVM，5-fold 交叉驗證
評估指標：AUC / Recall(min) / F1 / G-mean

執行：python 02v2_run_baselineB_VAE.py --data_root .
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Baseline B (VAE): DF_maj → VAE + OneClassSVM")
...
def main() -> None:
    ...
    print("=" * 70)
    print("Baseline B (VAE): DF_maj → VAE + OneClassSVM")
    ...
    xlsx_path = out_dir / "baseline_b_vae_v2_results.xlsx"
